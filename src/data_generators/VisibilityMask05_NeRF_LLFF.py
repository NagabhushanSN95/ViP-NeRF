    ...
    for scene_name in tqdm(scene_names):
        ...
        for frame1_num in frame_nums:
            for frame2_num in frame_nums:
                ...
                validity1_output_path = output_dirpath / f'{scene_name}/ValidityMasks/{frame1_num:04}_{frame2_num:04}.npy'
                validity2_output_path = output_dirpath / f'{scene_name}/ValidityMasks/{frame2_num:04}_{frame1_num:04}.npy'
                ...
                depth1_path = database_dirpath / f'all/EstimatedDepths/{depths_dirname}/{scene_name}/EstimatedDepths{suffix}/{frame1_num:04}.npy'
                depth2_path = database_dirpath / f'all/EstimatedDepths/{depths_dirname}/{scene_name}/EstimatedDepths{suffix}/{frame2_num:04}.npy'
                depth1_mask_path = database_dirpath / f'all/EstimatedDepths/{depths_dirname}/{scene_name}/ValidityMasks{suffix}/{frame1_num:04}.npy'
                depth2_mask_path = database_dirpath / f'all/EstimatedDepths/{depths_dirname}/{scene_name}/ValidityMasks{suffix}/{frame2_num:04}.npy'
