...
def demo1():
    ...
    avg_psnr = start_qa(pred_videos_dirpath, database_dirpath, frames_data_path, pred_folder_name, downsampling_factor,
                        mask_folder_name)
    return avg_psnr
...
def demo2(args: dict):
    ...
    avg_psnr = start_qa(pred_videos_dirpath, database_dirpath, frames_datapath, pred_folder_name, downsampling_factor,
                        mask_folder_name)
    return avg_psnr
