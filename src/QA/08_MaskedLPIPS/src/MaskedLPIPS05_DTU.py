...
class LPIPS:
    ...
    def compute_frame_lpips(self, gt_frame: numpy.ndarray, eval_frame: numpy.ndarray, mask: numpy.ndarray):
        ...
        gt_frame = mask_3d * gt_frame
        eval_frame = mask_3d * eval_frame
...
def demo1():
    ...
    avg_lpips = start_qa(pred_videos_dirpath, database_dirpath, frames_data_path, pred_folder_name, downsampling_factor,
                         mask_folder_name)
    return avg_lpips
...
def demo2(args: dict):
    ...
    avg_lpips = start_qa(pred_videos_dirpath, database_dirpath, frames_datapath, pred_folder_name, downsampling_factor,
                         mask_folder_name)
    return avg_lpips
