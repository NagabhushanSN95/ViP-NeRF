...
def run_all_qa(pred_videos_dirpath: Path, database_dirpath: Path, frames_datapath: Path, pred_folder_name: str,
    ...
    args_values = locals()
    metric_files = [
        this_filepath.parent / '../../01_RMSE/src/RMSE05_DTU.py',
        this_filepath.parent / '../../02_PSNR/src/PSNR05_DTU.py',
        this_filepath.parent / '../../03_SSIM/src/SSIM05_DTU.py',
        this_filepath.parent / '../../04_LPIPS/src/LPIPS05_DTU.py',
        this_filepath.parent / '../../05_MaskedRMSE/src/MaskedRMSE05_DTU.py',
        this_filepath.parent / '../../06_MaskedPSNR/src/MaskedPSNR05_DTU.py',
        this_filepath.parent / '../../07_MaskedSSIM/src/MaskedSSIM05_DTU.py',
        this_filepath.parent / '../../08_MaskedLPIPS/src/MaskedLPIPS05_DTU.py',
    ]
    qa_scores = {}
...
def demo1():
    ...
    mask_folder_name = 'object_masks'
    qa_scores = run_all_qa(pred_videos_dirpath, database_dirpath, frames_data_path, pred_folder_name,
