...
def demo1():
    ...
    avg_ssim = start_qa(pred_videos_dirpath, database_dirpath, frames_data_path, pred_folder_name, resolution_suffix,
                        downsampling_factor)
    return avg_ssim
...
def demo2(args: dict):
    ...
    avg_ssim = start_qa(pred_videos_dirpath, database_dirpath, frames_datapath, pred_folder_name, resolution_suffix,
                        downsampling_factor)
    return avg_ssim
